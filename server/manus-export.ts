...
function buildPrompt(
  ...
  slides.push(
    [
      ...
      `IMAGERY: Replicate the real SMB Smart CRM product interface as a realistic SaaS dashboard mockup occupying the right two-thirds of the slide. Match this exact structure, do not invent your own nav.`,
      `  Left sidebar (vertical, light background, with small icons next to each item) in this exact order from top to bottom:`,
      `    - Home`,
      `    - Conversations`,
      `    - CRM (with a small down chevron)`,
      `    - AI (with a small down chevron, shown expanded with three indented sub-items: Workforce, Capabilities, AI knowledge base)`,
      `    - Campaigns`,
      `    - Executive Report`,
      `    - Local SEO`,
      `    - Reputation AI`,
      ...
      `    - My Products`,
      `    - Automations`,
      `  Highlight "Home" as the active item using the deck primary color background or a left accent bar.`,
      `  Visually flag these four sidebar items as the FOUR PILLARS by placing a small colored dot or pillar icon to the left of each: AI (the AI Workforce pillar), Local SEO (the SEO and Listings pillar), Reputation AI (the Reputation pillar), Social Marketing (the Social Media pillar). The four colored dots together signal the four pillars at a glance.`,
      `  Top of the main panel (right two-thirds): page label "Home", a small "Invite team member" link on the right, and a date range chip "Last 90 days".`,
      `  Three KPI cards in a row across the top: Impressions 1,258, Engagement 51, Leads 37. Each card shows a small upward sparkline area chart in the accent color.`,
      `  Below the KPI cards, a small lead source list with channel icons: Phone calls 25, Form 5, SMS 2, Web Chat 2, AI Voice Receptionist 2.`,
      `  Bottom right of the main panel, a small "Products" panel listing: Social Marketing, Reputation AI, Local SEO (each with a small colored icon).`,
      hasLockedTheme
        ? `  Use primary color ${themePrimary} for the active sidebar highlight and section headings. Use accent color ${themeAccent} for the sparkline fills and small accent dots. White card backgrounds, soft gray dividers, rounded corners.`
        : `  Use the deck primary color for the active sidebar highlight and section headings, and the accent color for sparkline fills and small accent dots. White card backgrounds, soft gray dividers, rounded corners.`,
      `  Overall feel: modern, polished SaaS dashboard product screenshot, NOT a wireframe.`,
  ...
  return [
    ...
    "==================================================================",
    hasLockedTheme
      ? `This deck is a clean, professional client-facing presentation. LOCKED COLOR THEME: primary color ${themePrimary}, accent color ${themeAccent}. Use these exact colors on every slide for headings, accents, dividers, callouts, charts, and any branded highlights. Do not introduce other accent colors. Do not deviate from this palette. Do not add whiteboard, sketch, hand-drawn, marker, or photo aesthetics. Do not use illustrated cartoon doodles. Keep the design polished, modern, and on-brand for ${cn}. Lean into the IMAGERY directives on each slide: use 2D vector icons, simple charts, and clean dashboard or diagram mockups built from the template's editable element library.`
      : `This deck is a clean, professional client-facing presentation. Build the color theme around the colors in the client logo that has been attached (if a logo was attached). Pull a primary brand color and one or two accent colors from the logo and apply them consistently across every slide. Do not add whiteboard, sketch, hand-drawn, marker, or photo aesthetics. Do not use illustrated cartoon doodles. Keep the design polished, modern, and on-brand for ${cn}. Lean into the IMAGERY directives on each slide: use 2D vector icons, simple charts, and clean dashboard or diagram mockups built from the template's editable element library.`,
    "",
    "==================================================================",
    "TYPOGRAPHY LOCK (READ THIS BEFORE EVERY SLIDE)",
    "==================================================================",
    `Use a modern, professional sans-serif typeface across every slide, every title, every body line, every chart label, every dashboard mockup label, every pipeline card, every footer.`,
    `Acceptable typefaces, in priority order: Inter, Plus Jakarta Sans, Manrope, Poppins, Montserrat, Geist Sans, SF Pro, Helvetica Neue, Arial. Pick ONE for the whole deck and use it for everything.`,
    `Absolutely DO NOT use any of the following: monospace fonts, typewriter fonts, Courier, Courier New, Source Code Pro, IBM Plex Mono, JetBrains Mono, Roboto Mono, slab serifs, condensed display fonts, hand-drawn or marker fonts, retro pixel fonts, blackletter, or anything that looks like code or a terminal. The current robotic look is wrong and must not appear anywhere, including inside the CRM mockup.`,
    `Headings: bold weight, generous letter spacing, sentence case (or title case when it reads more natural). Body: regular or medium weight, comfortable line height (about 1.4 to 1.5).`,
    `Inside the CRM dashboard mockup specifically: all nav items, KPI numbers, pipeline card labels, and activity feed text must use the same modern sans-serif. No monospace anywhere in the mockup.`,
    "",
    "==================================================================",
    "DECK CONTENT",
    "==================================================================",
